...
void CIRCLE_DRAWbmp(bmpfile_t *bmp,  int x,  int y)   // Funtion to render a blue circular shape in the bmp format
{
...
void REMOVE_DRAWbmp(bmpfile_t *bmp, int x, int y)       // Function to reset the bmp to a white state
{
